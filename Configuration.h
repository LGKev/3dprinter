/**
   REV: 04.18.16, HIC i3 1.1.03-RC4
   ...
   3. 'red' HICTOP 'MPX.3' control board (Power Outputs: Extruder, Fan, Bed)
...
#ifndef MOTHERBOARD
#define MOTHERBOARD BOARD_RAMPS_14_EFB // was default, RAMPS 1.4 (Power outputs: Extruder, Fan, Bed)
//#define MOTHERBOARD BOARD_RAMPS_13_EFB // CL: original in RC3 for HIC i3, RAMPS 1.3 (Power outputs: Extruder, Fan, Bed)
//#define MOTHERBOARD BOARD_RAMPS_13_EEB // CL: test for E0 motor/controller, RAMPS 1.3 (Power outputs: Extruder0, Extruder1, Bed)
#endif
...
//#define EXTRUDERS 2  // CL: enable 2 to debug E0 motor/controller
...
// CL: HIC i3, NOTE: 'China' OEM code shows = type '3', other source for HIC i3 shows = type '1', =not sure?
#define TEMP_SENSOR_0 1
#define TEMP_SENSOR_1 0  // CL: enable E1 to debug E0 motor/controller
...
#define BED_MAXTEMP 120  // CL:, lower for HIC i3, was =275
...
#define PREVENT_DANGEROUS_EXTRUDE  // CL: disabled to debug extruder E0 motor/driver
//if PREVENT_DANGEROUS_EXTRUDE is on, you can still disable (uncomment) very long bits of extrusion separately.
#define PREVENT_LENGTHY_EXTRUDE

// IMPORTANT NOTE: your extruder will NOT FEED below this setting!
//#define EXTRUDE_MINTEMP 170 // default
...
// CL: set all to =true for HIC i3, was all =false
...
#define INVERT_Y_DIR false // CL: for HICis = false, was = true
#define INVERT_Z_DIR true // CL: for HICis = true, was = false
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER +74  // Y offset: -front [of the nozzle] +behind
...
// Default AXIS STEP Settings
// 1a) default axis steps per unit for Ultimaker steps/mm ={8.7402,78.7402,200.0*8/3,760*1.1}
// 1b) default axis steps per unit for HIC i3 steps/mm, original ={80,80,2560,94.4962144}, CL: HIC i3 current z-axis threaded rods : =8mm wide x 1.25mm pitch
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,94.4962144} // CL: default steps for _my_ HIC i3, you may need to change the Z and/or E for your machine

// Default MAXIMUM FEEDRATES (speed) - GLOBAL for printing and non-printing
// 1a) default max feedrates, original ={300,300,5,25}, (mm/sec)
#define DEFAULT_MAX_FEEDRATE          {120, 120, 3, 25} // CL: for _my_ HIC i3 (rated at 120mm/sec), (mm/sec)

// Default MAXIMUM ACCELERATION
// 1a) default maximum start speeds/acclerations, original ={9000,9000,100,10000} (mm/sec^2)
#define DEFAULT_MAX_ACCELERATION      {1200,1200,50,10000} // CL: for HIC i3, X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define DEFAULT_ACCELERATION          1200 // CL: was =3000, X, Y, Z and E acceleration in mm/s^2 for printing moves (i.e. : feedrates)
...
#define SPI_SPEED SPI_HALF_SPEED // (CL: HICi3 LCD panel, also SPI_QUARTER_SPEED, SPI_EIGHTH_SPEED) Use slower SD transfer mode (not normally needed - uncomment if you're getting volume init error)
#define SD_CHECK_AND_RETRY // CL: HICi3 LCD panel, Use CRC checks and retries on the SD communication
